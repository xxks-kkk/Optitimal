...
LoaderCallbacks<Cursor> {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.menu_settings:
			...
			//TODO: modified here
		case R.id.menu_plot:
			DialogFragment fragment = new ChartSelectionDialogFragment();
			android.support.v4.app.FragmentManager fragmentManager = getFragmentManager();
			fragment.show(fragmentManager, ChartSelectionDialogFragment.DEFAULT_DIALOG_FRAGMENT_TAG);
			//Cursor c = getActivity().getContentResolver().query(ReminderProvider.CONTENT_URI, null, null, null, null);

//			Intent i = new Intent(getActivity(), LineChartActivity.class);
//			startActivity(i);      
			return true;
		}
